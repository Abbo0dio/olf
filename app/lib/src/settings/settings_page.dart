...
import 'data_and_sharing_screen.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          // r3b moved "Prediction accuracy" + the Modes on/off entry to the
          // Patterns tab; r4 moved the data/sharing rows into their own screen
          // and dropped the "Pregnancy loss & birth" pointer (it lives in the
          // Calendar tab's overflow since r3a). Settings is settings-only now.
          ...
          ListTile(
            ...
            subtitle: const Text(
              'Backups, the doctor report, and connected health apps.',
            ),
            trailing: const Icon(Icons.chevron_right),
            onTap: () => Navigator.of(context).push(
              MaterialPageRoute<void>(
                builder: (_) => const DataAndSharingScreen(),
              ),
            ),
          ),
        ],
