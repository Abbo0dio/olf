...
/// Log (or edit) today's endometriosis pain / flare entry (p7.5).
///
...
/// row).
class EndometriosisPainSheet extends ConsumerStatefulWidget {
  const EndometriosisPainSheet({super.key});

  @override
  ConsumerState<EndometriosisPainSheet> createState() =>
      _EndometriosisPainSheetState();
}

class _EndometriosisPainSheetState
    extends ConsumerState<EndometriosisPainSheet> {
        ...
        children: [
          ...
          TextField(
            ...
            decoration: const InputDecoration(
              ...
              helperText:
                  'Stays on this device. Never shown in a notification.',
            ),
          ),
