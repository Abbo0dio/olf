...
| close | #83 | `(squash SHA on merge)` | Exit gate, `overview.md` row 7 → DONE, `architecture.md` refresh, p7.3 threat-model entry, this frozen record; carries the batched local-`main` bookkeeping stack. |
